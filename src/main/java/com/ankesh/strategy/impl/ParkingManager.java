 ...
 *
 */
package com.ankesh.strategy.impl;
...
public class ParkingManager<T extends Vehicle> implements ParkingDataManager<T> {
    ...
    public static <T extends Vehicle> ParkingManager<T> getInstance(int capacity,
                                                                    List<ParkingStrategy> parkingStrategies) {
        parkingStrategies.forEach(parkingStrategy -> {
            if (instance == null) {
                synchronized (ParkingManager.class) {
                    if (instance == null) {
                        instance = new ParkingManager<T>(capacity, parkingStrategy);
                    }
                }
            }
        });
    ...
    private ParkingManager(int capacity, ParkingStrategy parkingStrategy) {
